...
export const AdminLoginForm: React.FC<AdminLoginFormProps> = ({ onLoginSuccess, onStudentClick }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const loginResponse = await adminLogin({ cpf, senha: password });
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8 bg-white p-7 rounded-xl shadow-lg">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold text-gray-900">Boas vindas Administrador!</h2>
